...
if ($user) {
  ...
  // Check if need to clear the session global variable
...
<html xmlns:fb="http://www.facebook.com/2008/fbml">
  ...
  <body>
    <h1>php-sdk</h1>
    <p>User: <pre><?php echo print_r($user); ?> </pre></p>


    <?php if ($user): ?>
      

      <a href="fbk_logout.php"> 
        Logout
      </a>
      <p>Logout URL:<?php echo print_r($logoutUrl); ?></p>
    <?php else: ?>
      <div>
